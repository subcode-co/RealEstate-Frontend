    ...
    <section className="container space-y-6 py-12 flex items-center max-lg:flex-col max-lg:gap-6 ">
      ...
      <div className="lg:w-1/2 space-y-8  self-start">
        ...
        <h3 className="lg:text-[32px]  text-3xl font-semibold lg:w-[80%] lg:leading-16 leading-12">
          نضمن تعامل <span className="text-main-green">موثوق</span> وحماية عالية
          لبياناتك
        </h3>
        <p className="text-xs leading-6 lg:w-[90%] ">
          ...
          والتأجير وإدارة الأملاك، مع حلول مبتكرة مصممة خصيصًا لتناسب احتياجاتك.
          بفضل خبرتنا العميقة وفريقنا المتخصص، نمنحك فرصة استثمارية آمنة وتجربة
          سلسة ترتقي لتطلعاتك. نحن لا نقدم لك عقارًا فحسب، بل نصنع لك مستقبلًا
          مليئًا بالفرص والنجاح. اختر الحلول العقارية، حيث تتحول الأفكار إلى
          إنجازات، والطموحات إلى واقع ملموس.
        </p>
      </div>
      {/* image */}
      <div className=' lg:w-1/2 w-full rounded-3xl relative h-[50vh]  bg-[url("/images/about.jpg")] bg-cover '>
        {/* rate */}
