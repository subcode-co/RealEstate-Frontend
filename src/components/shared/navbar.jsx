  ...
  return (
    <div className='container py-4 space-y-2 bg-white'>
      ...
      <div className='bg-main-dark px-6 py-2 rounded-t-xl flex items-center justify-between'>
        {/* logo */}
        <Link href='/'>
          <Image src="/images/logo.svg" alt='logo' width={300} height={300} className='size-16 ' />
        </Link>
        {/* links */}
        ...
        {/* sheet  */}
        <Sheet>
          <SheetTrigger className='md:hidden'><GiHamburgerMenu className='text-white text-2xl hover:text-main-green' /></SheetTrigger>
          <SheetContent className={"bg-main-dark border-none"}>
            <SheetHeader>
              <SheetTitle>
                {/* logo */}
                <Link href='/'>
                  <Image src="/images/logo.svg" alt='logo' width={300} height={300} className='size-40 mx-auto ' />
                </Link>
              </SheetTitle>
